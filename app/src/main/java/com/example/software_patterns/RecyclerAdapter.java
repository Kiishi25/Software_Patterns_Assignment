...
public  class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public RecyclerAdapter(Context context, List<Products> uploads) {
        mContext = context;
        products = uploads;
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        Products currentProducts = products.get(position);
        holder.nameTextView.setText(currentProducts.getTitle());
        holder.priceTextView.setText(currentProducts.getPrice());
